...
hi ErrorMsg		ctermfg=160		ctermbg=none	cterm=bold		guifg=#ff2026	guibg=#3a3a3a	gui=bold
...
" Diff highlighting
hi DiffAdd		ctermfg=121		ctermbg=none	cterm=bold						guibg=#2a0d6a
hi DiffDelete	ctermfg=160		ctermbg=none	cterm=bold		guifg=#242424	guibg=#3e3969	gui=none
hi DiffText		ctermfg=111		ctermbg=none	cterm=bold						guibg=#73186e	gui=none
hi DiffChange	ctermfg=fg		ctermbg=none	cterm=bold						guibg=#382a37
